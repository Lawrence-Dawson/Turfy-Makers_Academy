//
//  RecipientSearchTableViewController.swift
//  Turfy
//
//  Created by Tam Borine on 31/10/2016.
...
class RecipientSearchTableViewController: UITableViewController, UITableViewDataSource {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // tableView.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath as IndexPath) as! RecipientSearchTableViewCell
        cell.alabel?.text = dataArray[0]
